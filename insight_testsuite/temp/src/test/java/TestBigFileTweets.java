...
public class TestBigFileTweets {
    ...
    public void testTweet() throws Exception {
        ...
        Tweet tweet = new Tweet(1459221792000l, Arrays.asList("hiring", "PaloAlto", "Healthcare", "Job", "Jobs"));
        String average = application.processTweet(tweet);
        assertEquals("2.00", average);
        tweet = new Tweet(1459221792000l, Arrays.asList("hiring", "Honolulu", "BusinessMgmt", "Job", "Jobs"));
        average = application.processTweet(tweet);
        assertEquals("2.28", average);
        tweet = new Tweet(1459221792000l, Arrays.asList("Brentwood", "Hospitality", "Job", "Jobs", "Hiring", "CareerArc"));
        average = application.processTweet(tweet);
        assertEquals("2.36", average);
        tweet = new Tweet(1459221792000l, Arrays.asList("directvrealmadrid", "FutbolTotalDIRECTV"));
        average = application.processTweet(tweet);
