...
public class TestDuplicateTweetWithTimeOrder {
    ...
    public void testTweet() throws Exception {
        ...
        tweet = new Tweet(DateUtil.getLongTimestamp("Thu Mar 24 17:51:55 +0000 2016"), new LinkedHashSet<String>(Arrays.asList("Spark", "Apache")));
        average = application.processTweet(tweet);
        assertEquals("1.00", average);
        tweet = new Tweet(DateUtil.getLongTimestamp("Thu Mar 24 17:52:15 +0000 2016"), new LinkedHashSet<String>(Arrays.asList("Apache", "Cassandra")));
        average = application.processTweet(tweet);
