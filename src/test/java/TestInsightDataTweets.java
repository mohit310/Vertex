...
public class TestInsightDataTweets {
    ...
    public void testTweet() throws Exception {
        ...
        tweet = new Tweet(DateUtil.getLongTimestamp("Thu Mar 24 17:51:15 +0000 2016"), new LinkedHashSet<String>(Arrays.asList("Apache", "Hadoop", "Storm")));
        average = application.processTweet(tweet);
        assertEquals("2.00", average);
        tweet = new Tweet(DateUtil.getLongTimestamp("Thu Mar 24 17:51:30 +0000 2016"), new LinkedHashSet<String>(Arrays.asList("Apache")));
        average = application.processTweet(tweet);
        assertEquals("2.00", average);
        tweet = new Tweet(DateUtil.getLongTimestamp("Thu Mar 24 17:51:55 +0000 2016"), new LinkedHashSet<String>(Arrays.asList("Flink", "Spark")));
        average = application.processTweet(tweet);
        assertEquals("2.00", average);
        tweet = new Tweet(DateUtil.getLongTimestamp("Thu Mar 24 17:51:58 +0000 2016"), new LinkedHashSet<String>(Arrays.asList("Spark", "HBase")));
        average = application.processTweet(tweet);
        assertEquals("2.00", average);
